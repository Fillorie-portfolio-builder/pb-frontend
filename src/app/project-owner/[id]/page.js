          ...
          <div className="col-span-2 bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-600 mt-1">
                I'm a small business owner passionate about creating innovative
                solutions for local businesses. With over 10 years of experience
                in the bakery industry, I'm always looking for fresh talent to
                help bring new ideas to life.
              </p>
            </div>
